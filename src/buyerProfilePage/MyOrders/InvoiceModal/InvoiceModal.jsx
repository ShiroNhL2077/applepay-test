          ...
          <div className="orders-body">
            {showQrCode ? (
              ...
              <div className="inner-body-box">
                <p>Order : {clickedInvoice ? clickedInvoice?.code : ""} </p>
                ...
                <div className="orders-tbl-container">
              ...
              <div className="invoice-name-icon d-flex align-items-center gap-2">
                <div className="ino-icon">
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g clip-path="url(#clip0_511_5287)">
                      <path
              ...
              <div className="invoice-icons d-flex gap-2">
                ...
                >
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g clip-path="url(#clip0_511_5291)">
                      <path
            ...
            <div className="my-order-tickets-container">
              <div className="order-body-tickets">
                {clickedInvoice?.tickets?.map((ticket, index) => (
                  <div className="order-body-ticket-box">
                    <div key={index} className="order-body-ticket-details">
                      ...
                      <div className="ticket-icn d-flex gap-2">
                        <button className="btn_orders">
                          <svg
                            width="16"
                            height="16"
